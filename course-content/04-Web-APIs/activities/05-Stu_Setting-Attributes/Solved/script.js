...
site1El.children[1].setAttribute("style", "text-decoration: underline; padding-left:10px; margin: 0");
...
for (var i = 0; i < siteTitles.length; i++) {
  sitesEl.children[1].setAttribute("href", sites[Math.floor(Math.random() * sites.length)]);
}
